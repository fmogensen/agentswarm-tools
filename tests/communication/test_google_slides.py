...
from tools.communication.google_slides.google_slides import GoogleSlides
...
class TestGoogleSlides:
    ...
    def test_initialization_success(self):
        ...
        tool = GoogleSlides(mode="test_value", slides=[], title=None)

        assert tool.tool_name == "google_slides"
    ...
    def test_validation_missing_required_param(self):
        ...
        with pytest.raises((ValidationError, PydanticValidationError, TypeError)):
            tool = GoogleSlides()  # Missing required parameters
    ...
    def test_mock_mode_detection(self):
        ...
        tool2 = GoogleSlides(mode="test_value", slides=[], title=None)
    ...
    def test_result_structure(self):
        ...
        assert metadata["tool_name"] == "google_slides"
