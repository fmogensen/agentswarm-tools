"""
Tests for Google Calendar Delete Event Tool
...
from tools.communication.google_calendar_delete_event.google_calendar_delete_event import GoogleCalendarDeleteEvent


class TestGoogleCalendarDeleteEvent:
    """Test suite for GoogleCalendarDeleteEvent tool."""
    ...
    def test_initialization_success(self):
        ...
        tool = GoogleCalendarDeleteEvent(event_id="test_value", send_updates="test_value")
    ...
    def test_validation_missing_required_param(self):
        ...
        with pytest.raises((ValidationError, PydanticValidationError, TypeError)):
            tool = GoogleCalendarDeleteEvent()  # Missing required parameters
    ...
    def test_mock_mode_detection(self):
        ...
        tool2 = GoogleCalendarDeleteEvent(event_id="test_value", send_updates="test_value")
    ...
    def test_result_structure(self):
        ...
        assert metadata["tool_name"] == "google_calendar_delete_event"
