...
class TestGmailRead:
    ...
    def test_initialization_success(self):
        ...
        tool = GmailRead(input="test query")
    ...
    def test_validation_missing_required_param(self):
        ...
        with pytest.raises((ValidationError, PydanticValidationError, TypeError)):
            tool = GmailRead()  # Missing required parameters
    ...
    def test_mock_mode_detection(self):
        ...
        tool2 = GmailRead(input="test query")
    ...
    def test_result_structure(self):
        ...
        assert metadata["tool_name"] == "gmail_read"
