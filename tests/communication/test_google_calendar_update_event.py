"""
Tests for Google Calendar Update Event Tool
...
class TestGoogleCalendarUpdateEvent:
    """Test suite for GoogleCalendarUpdateEvent tool."""
    ...
    def test_validation_missing_required_param(self):
        ...
        with pytest.raises((ValidationError, PydanticValidationError, TypeError)):
            tool = GoogleCalendarUpdateEvent()  # Missing required parameters
    ...
    def test_validation_invalid_param_type(self):
        ...
        with pytest.raises((ValidationError, PydanticValidationError, TypeError)):
            ...
            tool = GoogleCalendarUpdateEvent(**{"event_id": 12345})
    ...
    def test_mock_mode_detection(self):
        ...
        tool2 = GoogleCalendarUpdateEvent(event_id="test_value", summary=None, description=None)
    ...
    def test_result_structure(self):
        ...
        assert metadata["tool_name"] == "google_calendar_update_event"
