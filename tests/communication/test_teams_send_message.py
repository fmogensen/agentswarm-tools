"""
Tests for Teams Send Message Tool
...
class TestTeamsSendMessage:
    """Test suite for TeamsSendMessage tool."""
    ...
    def test_validation_missing_required_param(self):
        ...
        with pytest.raises((ValidationError, PydanticValidationError, TypeError)):
            tool = TeamsSendMessage()  # Missing required parameters
    ...
    def test_validation_invalid_param_type(self):
        ...
        with pytest.raises((ValidationError, PydanticValidationError, TypeError)):
            ...
            tool = TeamsSendMessage(**{"team_id": 12345})
    ...
    def test_result_structure(self):
        ...
        assert metadata["tool_name"] == "teams_send_message"
