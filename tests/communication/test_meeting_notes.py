...
class TestMeetingNotesAgent:
    """Test suite for MeetingNotesAgent tool."""
    ...
    def test_validation_missing_required_param(self):
        ...
        with pytest.raises((ValidationError, PydanticValidationError, TypeError)):
            tool = MeetingNotesAgent()  # Missing required parameters
    ...
    def test_validation_invalid_param_type(self):
        ...
        with pytest.raises((ValidationError, PydanticValidationError, TypeError)):
            ...
            tool = MeetingNotesAgent(**{"audio_url": 12345})
    ...
    def test_result_structure(self):
        ...
        assert metadata["tool_name"] == "meeting_notes_agent"
