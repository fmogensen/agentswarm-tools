"""
Tests for Read Email Attachments Tool
...
class TestReadEmailAttachments:
    """Test suite for ReadEmailAttachments tool."""
    ...
    def test_validation_missing_required_param(self):
        ...
        with pytest.raises((ValidationError, PydanticValidationError, TypeError)):
            tool = ReadEmailAttachments()  # Missing required parameters
    ...
    def test_validation_invalid_param_type(self):
        ...
        with pytest.raises((ValidationError, PydanticValidationError, TypeError)):
            ...
            tool = ReadEmailAttachments(**{"input": 12345})
    ...
    def test_mock_mode_detection(self):
        ...
        tool2 = ReadEmailAttachments(input="test query")
    ...
    def test_result_structure(self):
        ...
        assert metadata["tool_name"] == "read_email_attachments"
