...
class TestNotionSearch:
    """Test suite for NotionSearch tool."""
    ...
    def test_initialization_success(self):
        ...
        tool = NotionSearch(query="test query", max_results=10)
    ...
    def test_validation_missing_required_param(self):
        ...
        with pytest.raises((ValidationError, PydanticValidationError, TypeError)):
            tool = NotionSearch()  # Missing required parameters
    ...
    def test_mock_mode_detection(self):
        ...
        tool2 = NotionSearch(query="test query", max_results=10)
    ...
    def test_result_structure(self):
        ...
        assert metadata["tool_name"] == "notion_search"
