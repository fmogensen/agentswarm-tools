"""
Tests for Query Call Logs Tool
...
class TestQueryCallLogs:
    """Test suite for QueryCallLogs tool."""
    ...
    def test_validation_missing_required_param(self):
        ...
        with pytest.raises((ValidationError, PydanticValidationError, TypeError)):
            tool = QueryCallLogs()  # Missing required parameters
    ...
    def test_validation_invalid_param_type(self):
        ...
        with pytest.raises((ValidationError, PydanticValidationError, TypeError)):
            ...
            tool = QueryCallLogs(**{"phone_number": 12345})
    ...
    def test_mock_mode_detection(self):
        ...
        tool2 = QueryCallLogs(phone_number=None, start_date=None, end_date=None)
    ...
    def test_result_structure(self):
        ...
        assert metadata["tool_name"] == "query_call_logs"
