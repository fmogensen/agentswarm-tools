...
class TestSlackSendMessage:
    """Test suite for SlackSendMessage tool."""
    ...
    def test_initialization_success(self):
        ...
        tool = SlackSendMessage(channel="test_value", text="test query", thread_ts=None)
    ...
    def test_validation_missing_required_param(self):
        ...
        with pytest.raises((ValidationError, PydanticValidationError, TypeError)):
            tool = SlackSendMessage()  # Missing required parameters
    ...
    def test_validation_invalid_param_type(self):
        ...
        with pytest.raises((ValidationError, PydanticValidationError, TypeError)):
            ...
            tool = SlackSendMessage(**{"channel": 12345})
    ...
    def test_mock_mode_detection(self):
        ...
        tool2 = SlackSendMessage(channel="test_value", text="test query", thread_ts=None)
    ...
    def test_result_structure(self):
        ...
        assert metadata["tool_name"] == "slack_send_message"
