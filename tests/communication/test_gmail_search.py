...
class TestGmailSearch:
    """Test suite for GmailSearch tool."""
    ...
    def test_initialization_success(self):
        ...
        tool = GmailSearch(query="test query", max_results=10)
    ...
    def test_validation_missing_required_param(self):
        ...
        with pytest.raises((ValidationError, PydanticValidationError, TypeError)):
            tool = GmailSearch()  # Missing required parameters
    ...
    def test_mock_mode_detection(self):
        ...
        tool2 = GmailSearch(query="test query", max_results=10)
    ...
    def test_result_structure(self):
        ...
        assert metadata["tool_name"] == "gmail_search"
