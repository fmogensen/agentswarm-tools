"""
Tests for Unified Google Calendar Tool
...
from tools.communication.unified_google_calendar.unified_google_calendar import UnifiedGoogleCalendar


class TestUnifiedGoogleCalendar:
    """Test suite for UnifiedGoogleCalendar tool."""
    ...
    def test_initialization_success(self):
        ...
        tool = UnifiedGoogleCalendar(action=[], query=None, summary=None)

        assert tool.tool_name == "unified_google_calendar"
    ...
    def test_validation_missing_required_param(self):
        ...
        with pytest.raises((ValidationError, PydanticValidationError, TypeError)):
            tool = UnifiedGoogleCalendar()  # Missing required parameters
    ...
    def test_validation_invalid_param_type(self):
        ...
        with pytest.raises((ValidationError, PydanticValidationError, TypeError)):
            ...
            tool = UnifiedGoogleCalendar(**{"action": 12345})
    ...
    def test_mock_mode_detection(self):
        ...
        tool2 = UnifiedGoogleCalendar(action=[], query=None, summary=None)
    ...
    def test_result_structure(self):
        ...
        assert metadata["tool_name"] == "unified_google_calendar"
