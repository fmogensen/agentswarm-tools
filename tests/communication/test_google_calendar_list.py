"""
Tests for Google Calendar List Tool
...
class TestGoogleCalendarList:
    """Test suite for GoogleCalendarList tool."""
    ...
    def test_validation_missing_required_param(self):
        ...
        with pytest.raises((ValidationError, PydanticValidationError, TypeError)):
            tool = GoogleCalendarList()  # Missing required parameters
    ...
    def test_validation_invalid_param_type(self):
        ...
        with pytest.raises((ValidationError, PydanticValidationError, TypeError)):
            ...
            tool = GoogleCalendarList(**{"input": 12345})
    ...
    def test_mock_mode_detection(self):
        ...
        tool2 = GoogleCalendarList(input="test query")
    ...
    def test_result_structure(self):
        ...
        assert metadata["tool_name"] == "google_calendar_list"
