"""
Tests for Unified Google Workspace Tool
...
class TestUnifiedGoogleWorkspace:
    """Test suite for UnifiedGoogleWorkspace tool."""
    ...
    def test_validation_missing_required_param(self):
        ...
        with pytest.raises((ValidationError, PydanticValidationError, TypeError)):
            tool = UnifiedGoogleWorkspace()  # Missing required parameters
    ...
    def test_validation_invalid_param_type(self):
        ...
        with pytest.raises((ValidationError, PydanticValidationError, TypeError)):
            ...
            tool = UnifiedGoogleWorkspace(**{"workspace_type": 12345})
    ...
    def test_mock_mode_detection(self):
        ...
        tool2 = UnifiedGoogleWorkspace(workspace_type="test_value", mode="test_value", title=None)
    ...
    def test_result_structure(self):
        ...
        assert metadata["tool_name"] == "unified_google_workspace"
