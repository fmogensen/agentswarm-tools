...
from tools.communication.maps_search.maps_search import MapsSearch


class TestMapsSearch:
    """Test suite for MapsSearch tool."""
    ...
    def test_validation_missing_required_param(self):
        ...
        with pytest.raises((ValidationError, PydanticValidationError, TypeError)):
            tool = MapsSearch()  # Missing required parameters
    ...
    def test_mock_mode_detection(self):
        ...
        tool2 = MapsSearch(query="test query", max_results=10)
    ...
    def test_result_structure(self):
        ...
        assert metadata["tool_name"] == "maps_search"
