"""
Tests for Slack Read Messages Tool
...
class TestSlackReadMessages:
    """Test suite for SlackReadMessages tool."""
    ...
    def test_validation_missing_required_param(self):
        ...
        with pytest.raises((ValidationError, PydanticValidationError, TypeError)):
            tool = SlackReadMessages()  # Missing required parameters
    ...
    def test_validation_invalid_param_type(self):
        ...
        with pytest.raises((ValidationError, PydanticValidationError, TypeError)):
            ...
            tool = SlackReadMessages(**{"channel": 12345})
    ...
    def test_mock_mode_detection(self):
        ...
        tool2 = SlackReadMessages(channel="test_value", limit=10, oldest=None)
    ...
    def test_result_structure(self):
        ...
        assert metadata["tool_name"] == "slack_read_messages"
