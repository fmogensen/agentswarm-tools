...
class TestParallelPipeline:
    ...
    def test_add_pipelines(self):
        ...
        parallel = (
            ParallelPipeline("multi")
            .add_pipeline(pipeline1)
            .add_pipeline(pipeline2)
        )
    ...
    def test_execute_parallel(self):
        ...
        pipeline2 = (
            Pipeline("scholar")
            .add_step("search", mock_search, query="ML", max_results=3)
        )
