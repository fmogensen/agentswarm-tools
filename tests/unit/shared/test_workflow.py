...
class MockCrawlerTool(BaseTool):
    ...
    def _execute(self):
        return {
            "success": True,
            "content": f"Content from {self.url}",
            "url": self.url
        }
...
class TestWorkflowContext:
    ...
    def test_step_result_interpolation(self):
        ...
        context.set_step_result("search", {
            "urls": ["url1", "url2"],
            "count": 2
        }, success=True)
    ...
    def test_nested_interpolation(self):
        ...
        params = {
            "urls": "${steps.search.result.results}",
            "count": 2
        }
        ...
        workflow = {
            ...
            "steps": [
                ...
                },
                {
                    ...
                    "tool": "mock_crawler",
                    "params": {
                        "url": "${steps.search.result.results[0].url}"
                    }
                }
            ]
        }
            ...
            "steps": [
                {
                    ...
                    "else": {
                        "tool": "mock_search",
                        "params": {"query": "basic", "max_results": 5}
                    }
                }
            ]
        }
