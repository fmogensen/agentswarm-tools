...
class TestTaskToolValidation:
    ...
    def test_prompt_too_short(self):
        ...
        assert "at least 50 characters" in error_msg or "at least 50 characters" in error_msg.lower() or "String should have at least 50 characters" in error_msg
    ...
    def test_prompt_empty(self):
        ...
        error_msg = str(exc_info.value)
        assert "cannot be empty" in error_msg.lower() or "at least 50 characters" in error_msg.lower() or "string_too_short" in error_msg.lower()
    ...
    def test_description_empty(self):
        ...
        error_msg = str(exc_info.value)
        assert "cannot be empty" in error_msg.lower() or "at least 1 character" in error_msg.lower() or "string_too_short" in error_msg.lower()
